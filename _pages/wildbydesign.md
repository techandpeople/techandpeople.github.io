...
$(".carousel-inner").append('<div class="item"><img style="width:auto; max-height: 400px; margin-left:auto; margin-right:auto;" class="img-responsive imgpub" src="{{ site.url }}{{ site.baseurl }}/images/wild/{{highlight.photo}}" alt="{{highlight.alt}}"><p style="font-size: 0.9rem;font-style: italic; display: block; margin-left:auto; margin-right:auto;">{{highlight.caption}}</p></div>')
