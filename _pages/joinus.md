...
Parkinson's Disease poster" class="img-proposal">
<br>
<p style="padding-left:20px; padding-right:20px; padding-top: 25px; padding-bottom: 25px; margin-bottom:0 ">
...
<br>
<img src="{{ site.url }}{{ site.baseurl }}/images/proposals/PlayingWithOthers_poster-1.jpg" alt="Playing With Others poster" class="img-proposal">
<br>
<p style="padding-left:20px; padding-right:20px; padding-top: 25px; padding-bottom: 25px; margin-bottom:0 ">
